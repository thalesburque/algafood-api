...
public class RestauranteProdutoFotoController {
	...
	public FotoProdutoModel buscarFoto(@PathVariable Long restauranteId, @PathVariable Long produtoId) {
		...
		FotoProduto foto = catalogoFotoProduto.buscarComTratamentoErro(produtoId, restauranteId);
	...
	public void remover(@PathVariable Long restauranteId, @PathVariable Long produtoId) {
		catalogoFotoProduto.excluir(produtoId, restauranteId);
	}

	private boolean verificarCompatibilidadeMediatype(MediaType mediaTypeFoto, List<MediaType> mediaTypesAceitas)
