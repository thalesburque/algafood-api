...
import com.algaworks.algafood.core.config.ValidacaoException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleGenericException(Exception ex, WebRequest request) {
		...
		String detail = String.format("Ocorreu um erro inesperado no sistema. Tente novamente e se o "
				+ "problema persistir, entre em contato com o administrador.");
	...
	public ResponseEntity<?> handleEntidadeNaoEcontradaException(EntidadeNaoEncontradaException ex,
			WebRequest request) {
	...
	protected ResponseEntity<Object> handleExceptionInternal(Exception ex, Object body, HttpHeaders headers,
		...
		if (body == null) {
			body = Problem.builder().status(status.value()).title(status.getReasonPhrase())
					.userMessage(MSG_GENERICA_ERRO_USUARIO_FINAL).timestamp(LocalDateTime.now()).build();
	...
	private ResponseEntity<Object> handleValidationInternal(Exception ex, BindingResult bindingResult,
		...
		Problem problem = createProblemBuilder(status.value(), problemType, detail).userMessage(detail).objects(objects)
				.build();
